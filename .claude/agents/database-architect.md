...
skills: clerk-neon-auth, backend-design, superpowers:test-driven-development
mode: subagent
teamRole: teammate
...
2. **Claim Tasks**: Use `TaskUpdate` with `owner: "database-architect"` before starting
...
|-------|---------------|
| `clerk-neon-auth` | Auth implementation, Drizzle ORM, Neon PostgreSQL |
| `backend-design` | Database queries, schema design, migrations |
| `superpowers:test-driven-development` | Database tests, migration tests |
