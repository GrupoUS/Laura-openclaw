...
skills: performance-optimization, superpowers:test-driven-development
mode: subagent
teamRole: teammate
...
|-------|---------------|
| `performance-optimization` | Core Web Vitals, bundle analysis, profiling |
| `superpowers:test-driven-development` | Performance tests, benchmarks as specs |
