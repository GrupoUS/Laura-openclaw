...
skills: backend-design, clerk-neon-auth, superpowers:test-driven-development
mode: subagent
teamRole: teammate
...
2. **Claim Tasks**: Use `TaskUpdate` with `owner: "backend-specialist"` before starting
...
|-------|---------------|
| `backend-design` | API patterns, tRPC procedures, middleware, database queries |
| `clerk-neon-auth` | Auth implementation, database schema, Drizzle ORM |
