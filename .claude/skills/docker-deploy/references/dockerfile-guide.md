...
## Future: Monorepo Dockerfile

When migrating to TurboRepo monorepo, the Dockerfile switches to a 4-stage build using `turbo prune --docker` to create workspace-scoped images with pruned dependencies.
