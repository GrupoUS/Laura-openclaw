---
name: google-ai-sdk
description: Use when working with Google AI SDKs (@google/genai, @ai-sdk/google, Vercel AI SDK) for implementing AI features, debugging Gemini models, configuring thinking/tool-calling/structured-output, or generating images with Nano Banana Pro.
---
