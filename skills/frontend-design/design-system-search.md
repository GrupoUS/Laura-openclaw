...
```bash
python skills/frontend-design/scripts/search.py "<query>" --design-system
```

Example:

```bash
python skills/frontend-design/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python skills/frontend-design/scripts/search.py "<keyword>" --domain <domain>
```
...
```bash
python skills/frontend-design/scripts/search.py "<keyword>" --stack <stack>
```
...
```bash
# ASCII box (default)
python skills/frontend-design/scripts/search.py "fintech crypto" --design-system

# Markdown
python skills/frontend-design/scripts/search.py "fintech crypto" --design-system -f markdown
```
