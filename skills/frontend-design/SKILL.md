...
description: "Unified frontend design skill covering UI/UX design, Tailwind CSS v4, generative art (p5.js), canvas art (PDF/PNG), image generation (Nan..."
...
**Theme Assets:**
- CSS: `skills/gpus-theme/assets/theme-tokens.css`
- Tailwind: `skills/gpus-theme/assets/tailwind-theme.ts`
- shadcn: `skills/gpus-theme/assets/components.json`
...
```bash
python skills/frontend-design/scripts/generate_images.py "Your prompt" "output_filename"
```
...
```bash
# Full design system
python skills/frontend-design/scripts/search.py "saas dashboard" --design-system

# Domain-specific
python skills/frontend-design/scripts/search.py "minimalism" --domain style
python skills/frontend-design/scripts/search.py "elegant" --domain typography
python skills/frontend-design/scripts/search.py "animation" --domain ux
```
