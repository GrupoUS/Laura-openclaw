    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Grupo US HQ — Escritório Digital</p>
        </div>
      ...
      {isLoading && (
        <div className="flex items-center justify-center h-64">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-slate-400">Carregando escritório...</p>
          </div>
        </div>
      )}
      ...
      {isError && (
        <div className="bg-red-950/40 border border-red-900 rounded-lg px-4 py-3 text-red-400 text-sm">
          ⚠️ Não foi possível carregar os agentes. Gateway pode estar offline.
        </div>
      )}
