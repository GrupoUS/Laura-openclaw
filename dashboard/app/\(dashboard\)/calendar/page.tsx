...
export default function CalendarPage() {
  ...
  const departments = ['all', 'Coordenação', 'Comercial', 'Marketing', 'Jurídico', 'Diretoria']
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/calendar?start=${start.toISOString()}&end=${end.toISOString()}&department=${selectedDepartment}`)
