---
name: webapp-testing
description: "Web application testing skill using Antigravity browser and Playwright CLI."
...
> Web application testing skill using Antigravity browser and Playwright CLI. Use for E2E testing, visual debugging, interaction testing, accessibility checks, and deep audit strategies. Supports both live browser interaction via browser_subagent and headless automated testing via Playwright scripts.
