---
name: gpus-theme
description: "Portable GPUS design system theme (Portal Grupo US)."
...
```bash
cp skills/gpus-theme/assets/components.json ./components.json
```
...
```typescript
import { gpusTheme } from './skills/gpus-theme/assets/tailwind-theme';
